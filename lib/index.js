...
NwBuilder.prototype.handleMacApp = function () {
    ...
    this._forEachPlatform(function (name, platform) {
        ...
        if(self.options.macIcns) {
            allDone.push(Utils.copyFile(self.options.macIcns, path.resolve(self.getResourcesDirectoryPath(platform), semver.satisfies(self._version.version, '>=0.13.0-alpha1') ? 'app.icns' : 'nw.icns'), self));
        }
