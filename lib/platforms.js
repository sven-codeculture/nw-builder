...
module.exports = {
    ...
    win64: {
        ...
        files: { // First file must be the executable
            ...
            '>0.9.2 <0.12.0': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales'],
            '>=0.12.0 <0.13.0-alpha3': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales', 'd3dcompiler_47.dll', 'pdf.dll'],
            '>=0.13.0-alpha3 <0.13.0': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'node.dll', 'nw_elf.dll', 'nw.dll', 'resources.pak', 'snapshot_blob.bin'],
            '>0.13.0': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'ffmpeg.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'node.dll', 'nw_elf.dll', 'nw.dll', 'resources.pak', 'snapshot_blob.bin']
        },
